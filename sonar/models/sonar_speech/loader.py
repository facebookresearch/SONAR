...
@final
class SonarSpeechEncoderLoader(
    ModelLoader[SonarSpeechEncoderModel, SonarSpeechEncoderConfig]
):
    """Loads sonar models."""
...
load_sonar_speech_config = ModelConfigLoader[SonarSpeechEncoderConfig](
