...
from fairseq.models.bart.sign_transformer_encoder import SignTransformerEncoderBase
...
class BARTModel(TransformerModel):
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        encoder = SignTransformerEncoderBase(cfg, src_dict, embed_tokens)
    ...
    def forward(
        ...
        **kwargs,
        ...
        eos: int = self.eos
        if classification_head_name is not None:
            sentence_representation = x[src_tokens.eq(eos), :].view(x.size(0), -1, x.size(-1))[:, -1, :]
    ...
    def register_classification_head(self, name, num_classes=None, inner_dim=None, **kwargs):
        ...
        self.classification_heads[name] = BARTClassificationHead(
            ...
            do_spectral_norm=getattr(self.args, "spectral_norm_classification_head", False),
        )
